...
print(
    "You are running from angry pirates, where you come across a cross road. Which way you go? Type 'left' or 'right'.")
way = input().lower()
...
*****************************************
        ...
        input(
            "Wizard: 'Hello there mighty mortal. Before I let you through this bridge, you have to prove you're worthy by answering my questions correctly.'")
...
********************************************\n
                ...
                if animal == "dinosaur":
                    input(
                        "Wizard: 'You are surprising me human. But I haven't yet done with you. You shall correctly answer my third and final question.'")
...
******************************************************************************
                    ...
                    if movie == "shrek":
                        input(
                            "Wizard: 'You have proved yourself worthy. I have faith in you human. May all the gods be with you in your journey.'\n")
